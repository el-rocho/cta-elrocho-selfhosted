...
export const translations = {
  es: {
    ...
    legal: {
      ...
      storageText: 'Toda la información sobre cuentas, mediciones, perfiles, notas y configuraciones se procesan y guardan en la base de datos de esta instalación. El navegador también conserva una cookie o información de sesión y una caché local necesaria para el funcionamiento.',
      networkLabel: 'Comunicaciones:',
      networkText: 'La aplicación no recopila, transmite ni comparte datos con terceros, tampoco incluye publicidad ni servicios de analítica o seguimiento. Comunica exclusivamente con los clientes configurados.',
      ...
      filesText: 'Las copias y los informes generados contienen mediciones, datos de perfil y notas de salud. Al descargarlos o compartirlos salen del servidor y quedan bajo el control y la responsabilidad del usuario.',
  ...
  en: {
    ...
    legal: {
      ...
      storageText: 'All account, measurement, profile, note, and configuration information is processed and stored in this installation’s database. The browser also keeps a cookie or session information and a local cache required for operation.',
      networkLabel: 'Communications:',
      networkText: 'The application does not collect, transmit, or share data with third parties, and includes no advertising, analytics, or tracking services. It communicates exclusively with configured clients.',
      ...
      filesText: 'Generated backups and reports contain measurements, profile details, and health notes. Once downloaded or shared, they leave the server and remain under the user’s control and responsibility.',
